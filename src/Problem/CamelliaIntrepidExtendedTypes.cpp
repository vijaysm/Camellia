...
EOperator Camellia::combineOperators(EOperator op_first, EOperator op_second)
{
  switch (op_first) {
    case OP_VALUE:
      return op_second;
    ...
    case OP_DX:
      switch (op_second) {
        ...
        case OP_DZ:
          ...
          break;
        default:
          TEUCHOS_TEST_FOR_EXCEPTION(true, std::invalid_argument, "Unsupported op combination");
          break;
      }
    case OP_DY:
      switch (op_second) {
