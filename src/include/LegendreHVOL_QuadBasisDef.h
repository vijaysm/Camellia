...
//  for (int i=0; i<=this->_basisDegree; i++)
//  {
//    _legendreL2normsSquared[i] = sqrt(2.0 / (2*i-1)); // the squared L^2 norm of the (i-1)th Legendre polynomial...
//  }
//  if (_conforming)
//  {
//    _legendreL2normsSquared[0] = sqrt(2.0/3.0);
//    _legendreL2normsSquared[1] = sqrt(2.0/3.0);
//  }
////    cout << "Legendre L^2 norms squared:\n"  << _legendreL2normsSquared;
}
