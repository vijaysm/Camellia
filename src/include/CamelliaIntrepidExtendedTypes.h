...
namespace Camellia
{
  ...
  //! not all legal combinations yet supported -- for now, just first-order single component derivative (e.g. OP_DX + OP_DY = OP_DXDY)
  EOperator combineOperators(EOperator op_first, EOperator op_second);
